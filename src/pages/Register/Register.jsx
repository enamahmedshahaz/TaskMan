            ...
            <div className="hero min-h-screen bg-teal-100">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="py-6">Join TaskMan – Where Your Journey Begins! Sign up for a world of possibilities. Register now to unlock exclusive features, seamless collaboration, and personalized experiences. Let's build something incredible together. Get started on your path to success.</p>
                    </div>
