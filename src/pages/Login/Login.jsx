            ...
            <div className="hero min-h-screen bg-teal-100">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="py-6">Welcome to TaskMan — Your Gateway to Productivity! Securely access your account with a seamless login experience. Elevate your workflow, collaborate effortlessly, and unlock a world of possibilities. Login now to embark on a journey of efficiency and innovation.</p>
                    </div>
